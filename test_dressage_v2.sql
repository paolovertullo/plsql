...
BEGIN
    ...
    FOR r_gara IN (
        SELECT dg.sequ_id_dati_gara_esterna AS gara_id,
         ...
         WHERE dg.anno_manifestazione = 2025
           AND PKG_CALCOLI_PREMI_MANIFEST.GET_DISCIPLINA(dg.sequ_id_dati_gara_esterna) = 6  -- DRESSAGE
        ...
        BEGIN
            v_risultato_v2 := PKG_CALCOLI_PREMI_MANIFEST.handler_dressage_v2(
    ...
    DBMS_OUTPUT.PUT_LINE('TEST NON REGRESSIONE - DRESSAGE V2 (2025)');
    DBMS_OUTPUT.PUT_LINE('================================================================================');
